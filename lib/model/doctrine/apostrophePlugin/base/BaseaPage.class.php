 ...
 * @method aPage               setASearchDocuments()       Sets the current record's "aSearchDocuments" collection
 ...
 * @method aPage               setBlogItem()               Sets the current record's "BlogItem" value
 * @method aPage               setAPageToASearchDocument() Sets the current record's "aPageToASearchDocument" collection
 * 
 * @package    symfony
 * @subpackage model
