...
abstract class BaseaCategoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'a_person_list'    => new sfWidgetFormDoctrineChoice(array('multiple' => true, 'model' => 'aPerson')),
    ));
    ...
    $this->setValidators(array(
      ...
      'a_person_list'    => new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'aPerson', 'required' => false)),
    ));
  ...
  public function updateDefaultsFromObject()
  {
    ...
    if (isset($this->widgetSchema['a_person_list']))
    {
      $this->setDefault('a_person_list', $this->object->aPerson->getPrimaryKeys());
    }
  ...
  public function saveaPersonList($con = null)
  {
    if (!$this->isValid())
    {
      throw $this->getErrorSchema();
    ...
    $existing = $this->object->aPerson->getPrimaryKeys();
    $values = $this->getValue('a_person_list');
    if (!is_array($values))
    {
      $values = array();
    }
    ...
    if (count($unlink))
    {
      $this->object->unlink('aPerson', array_values($unlink));
    }

    $link = array_diff($values, $existing);
    if (count($link))
    {
      $this->object->link('aPerson', array_values($link));
    }
  }
