...
// link or alias. Examples: 'C:\\MySite\\assets\\' or '/root/mysite/assets/'.
...
/*
	...
	- FileTypesAbsolutePath: the physical path to the above folder. It must be
		...
		Examples: 'C:\\MySite\\assets\\' or '/root/mysite/assets/'.
	 ...
	 - QuickUploadAbsolutePath: the physical path to the above folder. It must be
		...
		Attention: It must end with a slash: '/'
	 	...
	 	"assets" directory to maintain backwards compatibility with older versions of FCKeditor.
	 	This is fine, but you in some cases you will be not able to browse uploaded files using file browser.
	 	Example: if you click on "image button", select "Upload" tab and send image
	 	to the server, image will appear in FCKeditor correctly, but because it is placed
	 	directly in /assets/ directory, you'll be not able to see it in built-in file browser.
